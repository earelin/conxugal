...
## Scope
- User-list page: every account with email, role, state, and created date (disabled accounts shown, not hidden).
...
## Acceptance criteria
- The list shows every account — enabled and disabled — with its email, role, state, and created date. ([SPEC-0003](../../specs/SPEC-0003-administration-area.md) #5)
