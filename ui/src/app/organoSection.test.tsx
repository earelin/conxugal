...
describe('the contratos menores section, mounted by the application router', () => {
  ...
  describe('the addresses that reach the section', () => {
  ...
  describe('what the page hands the section', () => {
  ...
  describe('the addresses it does not route', () => {
  ...
  describe("the page's own answers, at a family segment", () => {
