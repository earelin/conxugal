...
class UserAuthenticationProviderTest {
    ...
    void returns_success_with_user_role_for_valid_credentials() {
        ...
        when(authenticate.authenticate("ana@example.com", "correct-password")).thenReturn(Optional.of(user));
    ...
    void returns_success_with_admin_role_for_valid_credentials() {
        ...
        when(authenticate.authenticate("root@example.com", "correct-password")).thenReturn(Optional.of(user));
