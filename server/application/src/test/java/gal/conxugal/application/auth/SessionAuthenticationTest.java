...
class SessionAuthenticationTest {
    ...
    void authenticated_user_reaches_data_but_is_forbidden_from_admin() {
        ...
        assertThat(statusOf(protectedRequest("/api/data", sessionCookie))).isEqualTo(HttpStatus.OK.getCode());
        assertThat(statusOf(protectedRequest("/api/admin/reports", sessionCookie))).isEqualTo(HttpStatus.FORBIDDEN.getCode());
    }
    ...
    void authenticated_admin_reaches_both_data_and_admin() {
        ...
        assertThat(statusOf(protectedRequest("/api/data", sessionCookie))).isEqualTo(HttpStatus.OK.getCode());
        assertThat(statusOf(protectedRequest("/api/admin/reports", sessionCookie))).isEqualTo(HttpStatus.OK.getCode());
    }
