...
public class UserAuthenticationProvider implements HttpRequestAuthenticationProvider<Object> {
  ...
  public AuthenticationResponse authenticate(
      HttpRequest<Object> requestContext, AuthenticationRequest<String, String> authRequest) {
    Optional<User> user =
        authenticate.authenticate(authRequest.getIdentity(), authRequest.getSecret());
