...
class LicitacionStateIdConverterTest {

  private final LicitacionStateIdConverter converter = new LicitacionStateIdConverter();
  ...
  void persists_the_identity_as_the_bare_uuid_the_column_holds() {
    ...
    LicitacionStateId id = new LicitacionStateId(value);
  ...
  void reads_the_stored_uuid_back_as_the_identity() {
    ...
    assertThat(converter.convertToEntityValue(value, ConversionContext.DEFAULT))
        .isEqualTo(new LicitacionStateId(value));
  }
  ...
  void converts_the_generated_key_through_the_conversion_service_half() {
    ...
    assertThat(converter.convert(generated, LicitacionStateId.class, ConversionContext.DEFAULT))
        .contains(new LicitacionStateId(generated));
  }

  @Test
  void converts_no_generated_key_into_an_empty_result() {
    assertThat(converter.convert(null, LicitacionStateId.class, ConversionContext.DEFAULT))
        .isEmpty();
  }
}
