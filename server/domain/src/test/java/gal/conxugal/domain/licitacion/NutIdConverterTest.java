...
class NutIdConverterTest {

  private final NutIdConverter converter = new NutIdConverter();
  ...
  void converts_the_generated_key_through_the_conversion_service_half() {
    ...
    assertThat(converter.convert(generated, NutId.class, ConversionContext.DEFAULT))
        .contains(new NutId(generated));
  }

  @Test
  void converts_no_generated_key_into_an_empty_result() {
    assertThat(converter.convert(null, NutId.class, ConversionContext.DEFAULT))
        .isEmpty();
  }
}
