...
class ParticipationIdConverterTest {

  private final ParticipationIdConverter converter = new ParticipationIdConverter();
  ...
  void persists_the_identity_as_the_bare_uuid_the_column_holds() {
    ...
    ParticipationId id = new ParticipationId(value);
  ...
  void reads_the_stored_uuid_back_as_the_identity() {
    ...
    assertThat(converter.convertToEntityValue(value, ConversionContext.DEFAULT))
        .isEqualTo(new ParticipationId(value));
  }
  ...
  void converts_the_generated_key_through_the_conversion_service_half() {
    ...
    assertThat(converter.convert(generated, ParticipationId.class, ConversionContext.DEFAULT))
        .contains(new ParticipationId(generated));
  }

  @Test
  void converts_no_generated_key_into_an_empty_result() {
    assertThat(converter.convert(null, ParticipationId.class, ConversionContext.DEFAULT))
        .isEmpty();
  }
}
