...
class LicitacionIdConverterTest {

  private final LicitacionIdConverter converter = new LicitacionIdConverter();
  ...
  void persists_the_identity_as_the_bare_uuid_the_column_holds() {
    ...
    LicitacionId id = new LicitacionId(value);
  ...
  void reads_the_stored_uuid_back_as_the_identity() {
    ...
    assertThat(converter.convertToEntityValue(value, ConversionContext.DEFAULT))
        .isEqualTo(new LicitacionId(value));
  }
  ...
  void converts_the_generated_key_through_the_conversion_service_half() {
    ...
    assertThat(converter.convert(generated, LicitacionId.class, ConversionContext.DEFAULT))
        .contains(new LicitacionId(generated));
  }

  @Test
  void converts_no_generated_key_into_an_empty_result() {
    assertThat(converter.convert(null, LicitacionId.class, ConversionContext.DEFAULT))
        .isEmpty();
  }
}
