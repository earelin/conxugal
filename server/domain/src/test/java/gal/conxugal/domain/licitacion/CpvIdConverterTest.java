...
class CpvIdConverterTest {

  private final CpvIdConverter converter = new CpvIdConverter();
  ...
  void converts_the_generated_key_through_the_conversion_service_half() {
    ...
    assertThat(converter.convert(generated, CpvId.class, ConversionContext.DEFAULT))
        .contains(new CpvId(generated));
  }

  @Test
  void converts_no_generated_key_into_an_empty_result() {
    assertThat(converter.convert(null, CpvId.class, ConversionContext.DEFAULT))
        .isEmpty();
  }
}
