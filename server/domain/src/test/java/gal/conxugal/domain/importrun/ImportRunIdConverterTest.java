...
class ImportRunIdConverterTest {

  private final ImportRunIdConverter converter = new ImportRunIdConverter();
  ...
  void persists_the_identity_as_the_bare_uuid_the_column_holds() {
    ...
    ImportRunId id = new ImportRunId(value);
  ...
  void reads_the_stored_uuid_back_as_the_identity() {
    ...
    assertThat(converter.convertToEntityValue(value, ConversionContext.DEFAULT))
        .isEqualTo(new ImportRunId(value));
  }
  ...
  void converts_the_generated_key_through_the_conversion_service_half() {
    ...
    // through the core conversion service, so without this a claim would return a null id.
    assertThat(converter.convert(generated, ImportRunId.class, ConversionContext.DEFAULT))
        .contains(new ImportRunId(generated));
  }

  @Test
  void converts_no_generated_key_into_an_empty_result() {
    assertThat(converter.convert(null, ImportRunId.class, ConversionContext.DEFAULT))
        .isEmpty();
  }
}
