...
class LicitacionTramitacionTypeIdConverterTest {

  private final LicitacionTramitacionTypeIdConverter converter =
      new LicitacionTramitacionTypeIdConverter();
  ...
  void persists_the_identity_as_the_bare_uuid_the_column_holds() {
    ...
    LicitacionTramitacionTypeId id = new LicitacionTramitacionTypeId(value);
  ...
  void reads_the_stored_uuid_back_as_the_identity() {
    ...
    assertThat(converter.convertToEntityValue(value, ConversionContext.DEFAULT))
        .isEqualTo(new LicitacionTramitacionTypeId(value));
  }
  ...
  void converts_the_generated_key_through_the_conversion_service_half() {
    ...
    assertThat(
            converter.convert(
                generated, LicitacionTramitacionTypeId.class, ConversionContext.DEFAULT))
        .contains(new LicitacionTramitacionTypeId(generated));
  }
  ...
  void converts_no_generated_key_into_an_empty_result() {
    assertThat(
            converter.convert(
                null, LicitacionTramitacionTypeId.class, ConversionContext.DEFAULT))
        .isEmpty();
  }
}
