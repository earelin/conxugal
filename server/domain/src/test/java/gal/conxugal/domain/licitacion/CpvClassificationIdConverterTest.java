...
class CpvClassificationIdConverterTest {

  private final CpvClassificationIdConverter converter = new CpvClassificationIdConverter();
  ...
  void persists_the_identity_as_the_bare_uuid_the_column_holds() {
    ...
    CpvClassificationId id = new CpvClassificationId(value);
  ...
  void reads_the_stored_uuid_back_as_the_identity() {
    ...
    assertThat(converter.convertToEntityValue(value, ConversionContext.DEFAULT))
        .isEqualTo(new CpvClassificationId(value));
  }
  ...
  void converts_the_generated_key_through_the_conversion_service_half() {
    ...
    assertThat(converter.convert(generated, CpvClassificationId.class, ConversionContext.DEFAULT))
        .contains(new CpvClassificationId(generated));
  }

  @Test
  void converts_no_generated_key_into_an_empty_result() {
    assertThat(converter.convert(null, CpvClassificationId.class, ConversionContext.DEFAULT))
        .isEmpty();
  }
}
