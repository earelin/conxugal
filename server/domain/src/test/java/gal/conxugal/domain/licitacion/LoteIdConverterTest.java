...
class LoteIdConverterTest {

  private final LoteIdConverter converter = new LoteIdConverter();
  ...
  void converts_the_generated_key_through_the_conversion_service_half() {
    ...
    assertThat(converter.convert(generated, LoteId.class, ConversionContext.DEFAULT))
        .contains(new LoteId(generated));
  }

  @Test
  void converts_no_generated_key_into_an_empty_result() {
    assertThat(converter.convert(null, LoteId.class, ConversionContext.DEFAULT))
        .isEmpty();
  }
}
