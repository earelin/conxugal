 ...
 * around whatever arrived. Named for the sort rather than called {@code Direction} alone, because
 * the driving adapter that parses one has the pagination library's own direction in scope beside
 * it.
 *
