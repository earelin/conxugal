...
public class Argon2idPasswordEncoder implements PasswordEncoder {
    ...
    public String encode(String rawPassword) {
        ...
        return MEMORY_KB + ":" + ITERATIONS + ":" + PARALLELISM + ":" + base64(salt) + ":" + base64(hash);
    }
    ...
    private byte[] hash(String rawPassword, byte[] salt, int memoryKb, int iterations, int parallelism) {
