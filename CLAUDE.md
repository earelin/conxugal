...
docs/
  ...
  tasks/        FEAT-NNN/TASK-NNN-*.md # small, self-contained work, one folder per feature
...
`FEAT → TASK` via the `docs/tasks/FEAT-NNN/` folder plus each task's `feat:` frontmatter.
